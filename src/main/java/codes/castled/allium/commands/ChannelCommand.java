...
public final class ChannelCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        } else if (commandName.equals("l") || commandName.equals("local")) {
            // Toggle to local channel (or back to default if already in local)
            targetChannel = channelManager.getLocalChannelName();
            String current = channelManager.getWriteChannel(player.getUniqueId());
            if (targetChannel.equals(current)) {
                targetChannel = channelManager.getDefaultChannelName();
            }
        } else if (commandName.equals("g") || commandName.equals("global")) {
            targetChannel = channelManager.getDefaultChannelName();
        } else {
            targetChannel = channelManager.getDefaultChannelName();
        }
